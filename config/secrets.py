...
username = "saminathanms2004@gmail.com"       # Enter your username in the quotes
password = "Saminathanms@01"           # Enter your password in the quotes
...
llm_model = "llama3.2:3b"            # Examples: "gpt-3.5-turbo", "gpt-4o", "llama-3.2-3b-instruct", "qwen3:latest", "gemini-pro", "gemini-1.5-flash", "gemini-2.5-flash", "deepseek-llm:latest"
